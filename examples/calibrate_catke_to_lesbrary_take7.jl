...
directory = "calibrate_catke_to_lesbrary_take7/"
...
# pseudo_stepping = Kovachki2018InitialConvergenceRatio(; initial_convergence_ratio=0.1)
...
begin
    ...
    for step = ProgressBar(1:iterations)
        convergence_ratio = range(0.2, stop=0.01, length=iterations)[step]
