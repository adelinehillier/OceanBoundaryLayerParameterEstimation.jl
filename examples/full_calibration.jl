...
training = inverse_problem_sequence(two_day_suite_path_2m, N_ensemble, training_times)[1]
validation = inverse_problem_sequence(four_day_suite_path_2m, N_ensemble, validation_times)[1]
