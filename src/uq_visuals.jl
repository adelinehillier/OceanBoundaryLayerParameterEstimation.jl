...
generated by MCMC.
"""
function plot_mcmc_densities2!(fig, axes, chain_X, parameter_names; 
                                n_columns = 3,
                                directory = pwd(),
...
function plot_mcmc_densities2(chain_X, parameter_names; 
                                n_columns = 3, kwargs...)
    ...
    sample_means = plot_mcmc_densities2!(fig, axes, chain_X, parameter_names; n_columns, kwargs...)
