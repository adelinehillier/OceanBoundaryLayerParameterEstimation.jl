...
#                         :Cˢu => (name = "Convective adjustment TKE parameter", latex = L"C^s_U", default = 0.628, bounds = (0.0, 15.0)),
...
catke_parameter_guide = Dict(:Cᴰ => (name = "Dissipation parameter (TKE equation)", latex = L"C^D", default = 2.9079, bounds = (0.0, 30.0)), 
                        ...
                        :Cᴬc => (name = "Convective adjustment tracer parameter", latex = L"C^A_C", default = 0.6706, bounds = (0.0, 2.0)), 
                        :Cᴬe => (name = "Convective adjustment TKE parameter", latex = L"C^A_E", default = 0.2717, bounds = (0.0, 2.0)),
                        :Cᵇu => (name = "Convective adjustment TKE parameter", latex = L"C^b_U", default = 0.596, bounds = (0.0, 10.0)),
                        :Cᵇc => (name = "Convective adjustment TKE parameter", latex = L"C^b_C", default = 0.0723, bounds = (0.0, 5.0)),
                        :Cᵇe => (name = "Convective adjustment TKE parameter", latex = L"C^b_E", default = 0.637, bounds = (0.0, 5.0)),
                        :Cˢu => (name = "Convective adjustment TKE parameter", latex = L"C^s_U", default = 0.628, bounds = (0.0, 50.0)),
                        :Cˢc => (name = "Convective adjustment TKE parameter", latex = L"C^s_C", default = 0.426, bounds = (0.0, 20.0)),
                        :Cˢe => (name = "Convective adjustment TKE parameter", latex = L"C^s_E", default = 0.711, bounds = (0.0, 10.0)),
)
