...
catke_parameter_guide = Dict(:Cᴰ⁻ => (name = "Dissipation parameter (TKE equation)", latex = L"C^D", default = 2.9079, bounds = (0.0, 10.0)), 
                        :Cᵟu => (name = "Ratio of mixing length to grid spacing", latex = L"C^{\delta}u", default = 0.5, bounds = (0.0, 1.0)), 
                        :Cᵟc => (name = "Ratio of mixing length to grid spacing", latex = L"C^{\delta}c", default = 0.5, bounds = (0.0, 1.0)), 
                        :Cᵟe => (name = "Ratio of mixing length to grid spacing", latex = L"C^{\delta}e", default = 0.5, bounds = (0.0, 1.0)), 
                        :Cᵂu★ => (name = "TKE subgrid flux parameter", latex = L"C^W_{u\star}", default = 3.6188, bounds = (0.0,  2.0)), 
                        :CᵂwΔ => (name = "TKE subgrid flux parameter", latex = L"C^Ww\Delta", default = 1.3052, bounds = (0.0,  2.0)), 
                        :CᴷRiʷ => (name = "Stability function parameter", latex = L"C^KRi^w", default = 0.7213, bounds = (0.0, 1.0)), 
                        :CᴷRiᶜ => (name = "Stability function parameter", latex = L"C^KRi^c", default = 0.7588, bounds = (-1.0, 1.0)), 
                        :Cᴷu⁻ => (name = "Velocity diffusivity LB", latex = L"C^Ku^-", default = 0.1513, bounds = (0.0, 5.0)), 
                        :Cᴷu⁺ => (name = "Velocity diffusivity (UB-LB)/LB", latex = L"C^Ku^r", default = 3.8493, bounds = (0.0, 10.0)), 
                        :Cᴷc⁻ => (name = "Tracer diffusivity LB", latex = L"C^Kc^-", default = 0.3977, bounds = (0.0, 5.0)), 
                        :Cᴷc⁺ => (name = "Tracer diffusivity (UB-LB)/LB", latex = L"C^Kc^r", default = 3.4601, bounds = (0.0, 10.0)), 
                        :Cᴷe⁻ => (name = "TKE diffusivity LB", latex = L"C^Ke^-", default = 0.1334, bounds = (0.0, 5.0)), 
                        :Cᴷe⁺ => (name = "TKE diffusivity (UB-LB)/LB", latex = L"C^Ke^r", default = 8.1806, bounds = (0.0, 10.0)), 
...
# catke_parameter_guide = Dict(:Cᴰ => (name = "Dissipation parameter (TKE equation)", latex = L"C^D", default = 2.9079, bounds = (0.0, 1.0)), 
#                         :Cᵟu => (name = "Ratio of mixing length to grid spacing", latex = L"C^{\delta}u", default = 0.5, bounds = (0.0, 2.0)), 
#                         :Cᵟc => (name = "Ratio of mixing length to grid spacing", latex = L"C^{\delta}c", default = 0.5, bounds = (0.0, 2.0)), 
#                         :Cᵟe => (name = "Ratio of mixing length to grid spacing", latex = L"C^{\delta}e", default = 0.5, bounds = (0.0, 2.0)), 
#                         :Cᵂu★ => (name = "TKE subgrid flux parameter", latex = L"C^W_{u\star}", default = 3.6188, bounds = (5.0,  15.0)), 
#                         :CᵂwΔ => (name = "TKE subgrid flux parameter", latex = L"C^Ww\Delta", default = 1.3052, bounds = (5.0,  15.0)), 
#                         :CᴷRiʷ => (name = "Stability function parameter", latex = L"C^KRi^w", default = 0.7213, bounds = (0.0, 1.0)), 
#                         :CᴷRiᶜ => (name = "Stability function parameter", latex = L"C^KRi^c", default = 0.7588, bounds = (0, 1.0)), 
#                         :Cᴷu⁻ => (name = "Velocity diffusivity LB", latex = L"C^Ku^-", default = 0.1513, bounds = (0.0, 2.0)), 
#                         :Cᴷuʳ => (name = "Velocity diffusivity (UB-LB)/LB", latex = L"C^Ku^r", default = 3.8493, bounds = (0.0, 2.0)), 
#                         :Cᴷc⁻ => (name = "Tracer diffusivity LB", latex = L"C^Kc^-", default = 0.3977, bounds = (0.0, 2.0)), 
#                         :Cᴷcʳ => (name = "Tracer diffusivity (UB-LB)/LB", latex = L"C^Kc^r", default = 3.4601, bounds = (0.0, 2.0)), 
#                         :Cᴷe⁻ => (name = "TKE diffusivity LB", latex = L"C^Ke^-", default = 0.1334, bounds = (0.0, 2.0)), 
#                         :Cᴷeʳ => (name = "TKE diffusivity (UB-LB)/LB", latex = L"C^Ke^r", default = 8.1806, bounds = (0.0, 2.0)), 
#                         :Cᴬu => (name = "Convective mixing length parameter", latex = L"C^A_U", default = 0.0057, bounds = (0.0, 2.0)), 
#                         :Cᴬc => (name = "Convective mixing length parameter", latex = L"C^A_C", default = 0.6706, bounds = (0.0, 2.0)), 
#                         :Cᴬe => (name = "Convective mixing length parameter", latex = L"C^A_E", default = 0.2717, bounds = (0.0, 2.0)),
#                         :Cᵇu => (name = "Stratified mixing length parameter", latex = L"C^b_U", default = 0.596, bounds = (0.0, 4.0)),
#                         :Cᵇc => (name = "Stratified mixing length parameter", latex = L"C^b_C", default = 0.0723, bounds = (0.0, 4.0)),
