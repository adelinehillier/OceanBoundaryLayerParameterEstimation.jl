...
# catke_parameter_guide = Dict(:Cᴰ => (name = "Dissipation parameter (TKE equation)", latex = L"C^D", default = 2.9079, bounds = (0.0, 0.5)), 
...
#                         :Cᵂu★ => (name = "Mixing length parameter", latex = L"C^W_{u\star}", default = 3.6188, bounds = (0.0, 1.0)), 
#                         :CᵂwΔ => (name = "Mixing length parameter", latex = L"C^Ww\Delta", default = 1.3052, bounds = (0.0, 30.0)), 
#                         :CᴷRiʷ => (name = "Stability function parameter", latex = L"C^KRi^w", default = 0.7213, bounds = (0.0, 20.0)), 
...
#                         :Cᴷuʳ => (name = "Velocity diffusivity (UB-LB)/LB", latex = L"C^Ku^r", default = 3.8493, bounds = (0.0, 3.0)), 
#                         :Cᴷc⁻ => (name = "Tracer diffusivity LB", latex = L"C^Kc^-", default = 0.3977, bounds = (0.0, 0.8)), 
#                         :Cᴷcʳ => (name = "Tracer diffusivity (UB-LB)/LB", latex = L"C^Kc^r", default = 3.4601, bounds = (0.0, 30.0)), 
#                         :Cᴷe⁻ => (name = "TKE diffusivity LB", latex = L"C^Ke^-", default = 0.1334, bounds = (0.0, 0.5)), 
...
#                         :Cᵇu => (name = "Convective adjustment TKE parameter", latex = L"C^b_U", default = 0.596, bounds = (0.0, 1.5)),
#                         :Cᵇc => (name = "Convective adjustment TKE parameter", latex = L"C^b_C", default = 0.0723, bounds = (0.0, 0.3)),
#                         :Cᵇe => (name = "Convective adjustment TKE parameter", latex = L"C^b_E", default = 0.637, bounds = (0.0, 0.6)),
#                         :Cˢu => (name = "Convective adjustment TKE parameter", latex = L"C^s_U", default = 0.628, bounds = (0.0, 4.0)),
#                         :Cˢc => (name = "Convective adjustment TKE parameter", latex = L"C^s_C", default = 0.426, bounds = (0.0, 4.0)),
#                         :Cˢe => (name = "Convective adjustment TKE parameter", latex = L"C^s_E", default = 0.711, bounds = (0.0, 2.0)),
# )
catke_parameter_guide = Dict(:Cᴰ => (name = "Dissipation parameter (TKE equation)", latex = L"C^D", default = 2.9079, bounds = (0.0, 1.5)), 
                        :Cᴸᵇ => (name = "Mixing length parameter", latex = L"C^{\ell}_b", default = 1.1612, bounds = (0.0, 10.0)), 
                        :Cᵟu => (name = "Ratio of mixing length to grid spacing", latex = L"C^{\delta}u", default = 0.5, bounds = (0.0, 3.0)), 
                        :Cᵟc => (name = "Ratio of mixing length to grid spacing", latex = L"C^{\delta}c", default = 0.5, bounds = (0.0, 3.0)), 
                        :Cᵟe => (name = "Ratio of mixing length to grid spacing", latex = L"C^{\delta}e", default = 0.5, bounds = (0.0, 3.0)), 
                        :Cᵂu★ => (name = "Mixing length parameter", latex = L"C^W_{u\star}", default = 3.6188, bounds = (0.0, 2.5)), 
                        :CᵂwΔ => (name = "Mixing length parameter", latex = L"C^Ww\Delta", default = 1.3052, bounds = (0.0, 70.0)), 
                        :CᴷRiʷ => (name = "Stability function parameter", latex = L"C^KRi^w", default = 0.7213, bounds = (0.0, 50.0)), 
                        :CᴷRiᶜ => (name = "Stability function parameter", latex = L"C^KRi^c", default = 0.7588, bounds = (-1.5, 3.0)), 
                        :Cᴷu⁻ => (name = "Velocity diffusivity LB", latex = L"C^Ku^-", default = 0.1513, bounds = (0.0, 0.5)), 
                        :Cᴷuʳ => (name = "Velocity diffusivity (UB-LB)/LB", latex = L"C^Ku^r", default = 3.8493, bounds = (0.0, 6.0)), 
                        :Cᴷc⁻ => (name = "Tracer diffusivity LB", latex = L"C^Kc^-", default = 0.3977, bounds = (0.0, 1.2)), 
                        :Cᴷcʳ => (name = "Tracer diffusivity (UB-LB)/LB", latex = L"C^Kc^r", default = 3.4601, bounds = (0.0, 40.0)), 
                        :Cᴷe⁻ => (name = "TKE diffusivity LB", latex = L"C^Ke^-", default = 0.1334, bounds = (0.0, 0.8)), 
                        :Cᴷeʳ => (name = "TKE diffusivity (UB-LB)/LB", latex = L"C^Ke^r", default = 8.1806, bounds = (0.0, 100.0)), 
                        :Cᴬu => (name = "Convective adjustment velocity parameter", latex = L"C^A_U", default = 0.0057, bounds = (0.0, 0.2)), 
                        :Cᴬc => (name = "Convective adjustment tracer parameter", latex = L"C^A_C", default = 0.6706, bounds = (0.0, 2.0)), 
                        :Cᴬe => (name = "Convective adjustment TKE parameter", latex = L"C^A_E", default = 0.2717, bounds = (0.0, 2.0)),
                        :Cᵇu => (name = "Convective adjustment TKE parameter", latex = L"C^b_U", default = 0.596, bounds = (0.0, 5.0)),
                        :Cᵇc => (name = "Convective adjustment TKE parameter", latex = L"C^b_C", default = 0.0723, bounds = (0.0, 0.6)),
                        :Cᵇe => (name = "Convective adjustment TKE parameter", latex = L"C^b_E", default = 0.637, bounds = (0.0, 1.0)),
                        :Cˢu => (name = "Convective adjustment TKE parameter", latex = L"C^s_U", default = 0.628, bounds = (0.0, 10.0)),
                        :Cˢc => (name = "Convective adjustment TKE parameter", latex = L"C^s_C", default = 0.426, bounds = (0.0, 7.0)),
                        :Cˢe => (name = "Convective adjustment TKE parameter", latex = L"C^s_E", default = 0.711, bounds = (0.0, 2.5)),
)
